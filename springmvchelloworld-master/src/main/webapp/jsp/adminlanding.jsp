...
<div class="container">
        <div class="row">
                <div class="column">
               <a href="aboutexcelupload.html" id="add" ><img src="Images/excel.jfif" alt="add" class="thumbnails" width="200" height="200"/></a>
               <H4>UPLOAD EXCEL</H4>
                </div>
                <div class="column">
               <a href="aboutmanagecompany.html" id="issue" ><img src="Images/managecompany.png" alt="issue" class="thumbnails" width="200" height="200"/></a>
               <H4>MANAGE COMPANIES</H4>
                </div>
                <div class="column">
               <a href="aboutmanageexchange.html" id="return" ><img src="Images/stockmanage.jfif" alt="return" class="thumbnails" width="200" height="200"/></a>
